...
#Prints a Full List of Trunk Ports
        ...
        trunklist = subprocess.call("snmpbulkwalk -v2c -c GLSCemexSnmp1 {} 1.3.6.1.4.1.9.9.46.1.6.1.1.14 > intlisttrunkstatus".format(ip), shell=True)
...
#Prints a Full List of Stack Ports
        ...
        stacklist = subprocess.call("snmpbulkwalk -v2c -c GLSCemexSnmp1 {} 1.3.6.1.4.1.9.9.500.1.2.2.1.1 > intliststackstatus".format(ip), shell=True)
